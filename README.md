...
- **Cámaras**: vídeo en directo insertado en la propia página (vía el reproductor público de
  ...
  La Puntilla, vista general) en vez de acumular enlaces repetidos a la misma vista. Se intentó
  incrustar las 3 cámaras de SkylineWebcams como foto auto-actualizable, pero su CDN bloquea el
  hotlink (`net::ERR_BLOCKED_BY_ORB` en el navegador) — se quedan como enlace.
